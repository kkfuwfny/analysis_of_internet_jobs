...
class BloomFilter():
    ...
    def __init__(self,filePath='',isTruncate = False, BIT_SIZE=1<<25):
	self.filePath = filePath
	self.isTruncate = isTruncate        
	self.BIT_SIZE = 1 << 25
	...
	self.fsh = open(self.filePath,'r+')
	#print self.filePath
	if self.isTruncate == True:      #是否清空该文件
 	    self.fsh.truncate()     
